...
public class Implemations implements EmpOperations {
	...
	public void addEmp(Emp emp) {
		...
		try {
			preparedStatement = GetConnection.getConnection().prepareStatement("insert into employees values(?,?,?)");
	...
	public void deleteEmp(Emp emp) {
		...
		PreparedStatement preparedStatement;
		try {
			preparedStatement = GetConnection.getConnection().prepareStatement("delete from employees where id=?");
	...
	public String[] searchEmp(Emp emp) {
		...
		try {
			preparedStatement = GetConnection.getConnection().prepareStatement("select * from employees where id =?");
			preparedStatement.setInt(1, emp.getId());
	...
	public List<String[]> showEmp() {
		...
		PreparedStatement preparedStatement;
		try {
			preparedStatement = GetConnection.getConnection().prepareStatement("select * from employees");
